...
<div class="box">
    ...
    if($driveOn == true)
    {
        echo ("<p><span style=\"color:lawngreen;text-align:center;\">U mag doorrijden</span></p>"); // Waarom is dit groen?
    }
    else if($driveOn == false)
    {
        echo ("<p><span style=\"color:red;text-align:center;\">U moet stoppen</span></p>"); // Waarom is dit groen?
    }
    ?>
    <h1>Taak 3</h1>
    <?php
